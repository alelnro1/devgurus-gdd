...
{
    public partial class Estadistico_Cliente_Inhab : Form
    {
        private EstadisticasDAO estadisticasDAO;
        
        public Estadistico_Cliente_Inhab(string anio, int trimestre)
        {
            InitializeComponent();
        ...
        {
            Info_estadistica.Text = "Clientes con cuentas inhabilitadas por falta de pago por transacción en año " +
            anio + " y periodo " + dameElNombreDeTrimestre(trimestre) + ".";
            string procedimiento = ConstantesBD.proc_listar_Cuent_Inahb;
            ...
            while (lector.Read())
            {
                ...
                columnas[3] = lector["Cantidad_Cuentas_Inhabilitadas"];

...
Create Table Usuarios	(	Usuarios_Id numeric(18,0) Identity(1,1) Primary key NOT NULL,
							...
							Usuarios_Rol numeric(18,0) FOREIGN KEY REFERENCES Rol_X_Usuario(Rol_X_Usuario_Id) NOT NULL,
...
Create Table Rol_X_Usuario(	Rol_X_Usuario_Usuario numeric (18,0) NOT NULL FOREIGN KEY REFERENCES Usuarios(Usuario_Id),
...
Create Table Transaccion_Pendiente	(	Transaccion_Pendiente_Id numeric (18,0) IDENTITY(1,1) PRIMARY KEY NOT NULL,
										...
										Transaccion_Pendiente_Cliente numeric (18,0) FOREIGN KEY REFERENCES Clientes(Clientes_Id),
